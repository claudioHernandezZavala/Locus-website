...
const DownloadButton = ({ primary = false }) => {
    ...
    const fetchLatestRelease = async () => {
      try {
        const response = await fetch(
          "https://api.github.com/repos/noevoapps/Locus-NoteBook/releases/latest",
        );
        ...
        if (exeAsset) {
          ...
          // Fallback if no exe asset found
          setDownloadUrl(
  ...
  return (
    ...
    >
      ...
      <Monitor
        className={`w-4 h-4 shrink-0 ${primary ? "text-indigo-600" : ""}`}
      />
      <span className="relative z-10">Download for Windows</span>
      {primary && (
        <span className="opacity-30 font-light mx-1 relative z-10">|</span>
      )}
      <span
        className={`text-xs ${primary ? "opacity-60" : "opacity-50"} font-normal relative z-10`}
      >
        {version} Free
      </span>
    </a>
...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "py-3 bg-[#0B0C10]/80 backdrop-blur-md border-b border-white/5" : "py-5 bg-transparent"}`}
    >
      <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-3 group cursor-pointer">
          ...
          <span className="font-bold text-lg tracking-tight text-slate-100">
            Locus <span className="text-slate-500 font-normal">NoteBook</span>
          </span>
        </div>
      </div>
    </nav>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="space-y-8 animate-[fadeIn_1s_ease-out]">
          ...
          <p className="text-lg text-slate-400 leading-relaxed max-w-md">
            Locus transforms your chaotic lectures into structured knowledge
            using local AI. No cloud uploads. No monthly fees.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <div className="flex flex-col">
              ...
              <p className="text-xs text-slate-500 mt-3 max-w-xs">
                Windows might show a 'Protected your PC' warning because this
...
const FeatureCard = ({ icon: Icon, title, desc, colSpan = "col-span-1" }) => (
  <div
    className={`locus-card p-6 rounded-xl group ${colSpan} relative overflow-hidden`}
  >
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="max-w-2xl mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
            Built for <span className="text-gradient-accent">deep focus</span>.
          </h2>
          <p className="text-slate-400 text-lg">
            Everything you need to capture and understand your lectures, without
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div className="bg-[#0B0C10] rounded-lg p-6 font-mono text-xs overflow-hidden leading-relaxed border border-white/5 shadow-inner">
              ...
              <div className="space-y-4">
                ...
                <div className="text-slate-400">
                  ...
                  <span className="text-emerald-400">Done (1.2s)</span>
                </div>
                ...
                <div className="p-3 bg-[#16181F] rounded border border-white/5 text-slate-300">
                  <span className="text-indigo-400 font-bold block mb-1 text-[10px] uppercase tracking-wider">
                    Flashcard Created
                  </span>
        ...
        <div className="order-1 md:order-2 space-y-6">
          ...
          <p className="text-slate-400 text-lg leading-relaxed">
            Locus replaces complex cloud setups with a single, efficient desktop
            app. It's designed to be the fastest way to go from listening to
            learning.
          </p>
  ...
  <section className="py-32 text-center relative overflow-hidden">
    ...
    <div className="max-w-3xl mx-auto px-6 relative z-10">
      ...
      <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto">
        Join students using Locus NoteBook to keep their data private and their
        studies organized.
      </p>
      <div className="flex flex-col items-center gap-6">
        <div className="flex flex-col items-center">
          <DownloadButton primary={true} />
          <p className="text-xs text-slate-500 mt-3 max-w-sm text-center">
            Windows might show a 'Protected your PC' warning because this app is
            new. Click 'More Info' → 'Run Anyway' to install.
          </p>
        </div>
...
const Footer = () => (
  <footer className="py-12 border-t border-white/5 bg-[#050608] text-xs text-slate-500">
    <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div>&copy; 2024 Locus Project.</div>
    </div>
  </footer>
);
